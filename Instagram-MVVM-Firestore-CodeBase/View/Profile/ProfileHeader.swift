...
class ProfileHeader: UICollectionReusableView {
    ...
    private let profileImageView: UIImageView = {
        ...
        iv.backgroundColor = .lightGray // for loading image
        return iv
    }()
    ...
    // define using "lazy var" because of accessing "addTarget()".
    // this method can be accessed after initializing
    ...
    // define using "lazy var" because of accessing "attributedText".
    // this property can be accessed after initializing
